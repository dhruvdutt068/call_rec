-- ====================================================================
-- PHASE 2: SERVER-SIDE CENTRALIZED IDENTITY RESOLUTION MIGRATION
-- (TIMESTAMPTZ / DATETIME DATATYPES)
-- ====================================================================
...
-- 2. People Table (Canonical CRM Person)
...
CREATE TABLE IF NOT EXISTS public.phone_numbers (
    ...
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    CONSTRAINT uq_phone_numbers_normalized UNIQUE (normalized_number)
);
...
-- 5. Atomic RPC: resolve_and_attach_contact
